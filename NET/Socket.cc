...
namespace NET {
  ...
  void
  Socket::startListen (int listen_port, const char* listen_target, uint32_t backlog)
  {
	Socket socketBind   (socket_domain, listen_port, listen_target);
	Socket socketListen (backlog);
